    ...
    <PublicLayout>
      <section className="relative isolate overflow-hidden bg-forest">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-36">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-accent">DDP AGRO</p>
          ...
          <p className="mt-6 max-w-xl text-base text-primary-foreground/80 sm:text-lg">
            Marketplace privado de máquinas e implementos agrícolas usados. Um ambiente fechado,
            formado por membros e construído sobre confiança.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
            <p>
              O DDP AGRO nasce de uma constatação simples: comprar ou vender uma máquina agrícola
              usada deveria ser muito mais seguro, transparente e profissional do que normalmente é.
            </p>
            <p>
              ...
              manutenção, conhecimento e patrimônio. Apesar disso, encontrar o equipamento certo,
              avaliar uma oportunidade, identificar um vendedor confiável e conduzir uma negociação
              segura ainda pode ser uma experiência fragmentada, informal e pouco transparente.
            </p>
            <p>
              Foi para resolver esse problema que nasceu o DDP AGRO. Uma plataforma criada para
              aproximar quem quer vender de quem realmente quer comprar, dentro de um ambiente
              fechado, formado por membros e construído sobre confiança.
            </p>
            <p className="font-medium text-forest">
              Não queremos ser apenas mais um classificados. Queremos criar um novo padrão para a
              negociação de máquinas agrícolas usadas.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-border bg-secondary/50">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-display text-3xl font-bold text-forest">
              Conectar compradores e vendedores de máquinas e implementos agrícolas usados em um
              ambiente privado, especializado, confiável e transparente.
            </h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            ...
            <h2 className="mt-4 font-display text-3xl font-bold text-forest">
              Ser a principal referência brasileira em negociação privada de máquinas e implementos
              agrícolas usados.
            </h2>
            <p className="mt-6 text-sm leading-relaxed text-muted-foreground sm:text-base">
              Queremos ser reconhecidos pela confiança, qualidade dos anúncios e experiência de
              negociação que oferecemos aos nossos membros.
            </p>
          ...
          <div className="order-1 lg:order-2 rounded-2xl bg-forest p-8 text-primary-foreground sm:p-12">
            ...
            <p className="mt-6 text-sm leading-relaxed text-primary-foreground/80 sm:text-base">
              Aproximando pessoas e oportunidades que realmente podem transformar negócios. Uma
              máquina usada ainda tem muito valor. Ela pode mudar de proprietário sem perder sua
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
              Estamos à disposição para esclarecer dúvidas sobre a plataforma, membresia, anúncios e
              negociações.
            </p>
          ...
          <div className="rounded-2xl bg-forest p-8 text-primary-foreground sm:p-12">
            <h3 className="font-display text-2xl font-bold">Quer fazer parte da plataforma?</h3>
